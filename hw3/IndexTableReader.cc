...
<<<<<<< HEAD
    Verify333(fread(&header.word_bytes,
              sizeof(header.word_bytes), 1, file_) == 1);
    Verify333(fread(&header.postings_bytes,
              sizeof(header.postings_bytes), 1, file_) == 1);
=======
    fread(&header.word_bytes, sizeof(header.word_bytes), 1, file_);
    fread(&header.postings_bytes, sizeof(header.postings_bytes), 1, file_);
>>>>>>> meganaHW4
