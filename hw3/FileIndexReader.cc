...
=======
  ...
  fread(&header_.magic_number, sizeof(header_.magic_number), 1, file_);
  // Don't need to seek as long as we go in order  
  fread(&header_.checksum, sizeof(header_.checksum), 1, file_);
  fread(&header_.doctable_bytes, sizeof(header_.doctable_bytes), 1, file_);
  fread(&header_.index_bytes, sizeof(header_.index_bytes), 1, file_);
>>>>>>> meganaHW4
